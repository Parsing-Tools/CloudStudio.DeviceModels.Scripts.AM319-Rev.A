...
# Parsing + Configuration Script – AM319 - Rev. A

This **Parsing + Configuration** script is designed for the **AM319** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – AM319 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **AM319** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
